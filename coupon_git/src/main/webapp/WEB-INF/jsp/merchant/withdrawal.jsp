        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="col-md-4 pull-right">
                    <button id="${swdflist.merchantId}" type="button" onclick="pass_chushen(this)" class="btn btn-success w-45 js-check-success">通过</button>
                    <button id="${swdflist.merchantId}" type="button" onclick="refuse_chushen(this)" class="btn btn-danger pull-right w-45 js-check-failed">拒绝</button>
