...
/**
 * Created by ziqiji on 17/3/9.
 */

public class HttpTaskForJsonTool extends AsyncTask<Void, Void, String> {
    ...
    public HttpTaskForJsonTool(String conditionString, String urlString){
