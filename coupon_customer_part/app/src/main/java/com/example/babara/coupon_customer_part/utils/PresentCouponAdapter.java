...
/**
 * Created by ziqiji on 17/4/14.
 */

public class PresentCouponAdapter extends ArrayAdapter<CouponItem> {
    private int textViewResource;
    public PresentCouponAdapter(Context context, int textViewResource, List<CouponItem> objects){
